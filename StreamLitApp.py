...
#     mcq_count = st.number_input("How many MCQs do you want to generate? ", min_value = 3, max_value = 50)

#     subject = st.text_input("Insert the subject related to the file uploaded above: ", max_chars = 20)

#     tone = st.text_input("What should be the complexity of the generated questions: ", max_chars = 20, placeholder = "Simple")
